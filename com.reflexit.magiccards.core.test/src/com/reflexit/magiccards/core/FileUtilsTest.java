...
public class FileUtilsTest extends TestCase {
	...
	public void testZip(){
		...
		assertTrue(new File(restoreDir, FileUtils.MAGICCARDS+"/"+ fLib.getLocation().getPath()+"/"+defaultLib.getLocation().getBaseFileName()).exists());
		...
		exclude.add(FileUtils.getWorkspaceFile(FileUtils.MAGICCARDS+"/"+ fLib.getLocation().getPath()+"/"+defaultLib.getLocation().getBaseFileName()));
