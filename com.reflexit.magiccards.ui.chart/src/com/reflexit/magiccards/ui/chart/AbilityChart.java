...
public class AbilityChart implements IChartGenerator {
	private double[] series;
	private String[] labels;

	public AbilityChart(Integer[] ibars, String[] seriesLabels) {
	...
	public Chart create() {
		...
		// Title
		cwoaPie.getTitle().getLabel().getCaption().setValue("Keyword Abilities");//$NON-NLS-1$
		// Data Set
