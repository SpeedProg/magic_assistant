...
public class SWTTextEditor {
	...
	SWTTextEditor() {
		...
		final Image saveIcon = MagicUIActivator.getImage(ISharedImages.IMG_ETOOL_SAVE_EDIT);
		final Image openIcon = MagicUIActivator.getImage(ISharedImages.IMG_OBJ_FILE);
		final Image childIcon = null;
		final Image cutIcon = MagicUIActivator.getImage(ISharedImages.IMG_TOOL_CUT);
		final Image copyIcon = MagicUIActivator.getImage(ISharedImages.IMG_TOOL_COPY);
		final Image pasteIcon = MagicUIActivator.getImage(ISharedImages.IMG_TOOL_PASTE);
