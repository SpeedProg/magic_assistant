 ...
 * @see SubMonitor
 */
public class SubCoreProgressMonitor extends ProgressMonitorWrapper {
	/**
	 * Style constant indicating that calls to <code>subTask</code> should not have any effect.
	 * 
	 * @see #SubProgressMonitor(ICoreProgressMonitor,int,int)
	 */
	 ...
	 */
	public SubCoreProgressMonitor(ICoreProgressMonitor monitor, int ticks) {
	 ...
	 */
	public SubCoreProgressMonitor(ICoreProgressMonitor monitor, int ticks, int style) {
		super(monitor);
	 ...
	 * <code>ICoreProgressMonitor.beginTask</code>.
	 * 
	 * Starts a new main task. Since this progress monitor is a sub progress monitor, the given name
	 * will NOT be used to update the progress bar's main task label. That means the given string
	 * will be ignored. If style <code>PREPEND_MAIN_LABEL_TO_SUBTASK <code> is specified, then the
	 * given string will be prepended to every string passed to <code>subTask(String)</code>.
	 */
	@Override
	...
	/*
	 * (Intentionally not javadoc'd) Implements the method <code>ICoreProgressMonitor.done</code>.
	 */
	@Override
	public void done() {
	 ...
	 * <code>ICoreProgressMonitor.internalWorked</code>.
	 */
	@Override
	...
	/*
	 * (Intentionally not javadoc'd) Implements the method
	 * <code>ICoreProgressMonitor.subTask</code>.
	 */
	@Override
	...
	/*
	 * (Intentionally not javadoc'd) Implements the method <code>ICoreProgressMonitor.worked</code>.
	 */
	@Override
